...
func initSchemas() {
	doublePinyin = schema{
		...
		path:            filepath.Join(RimeDir, "dicts_en/cn_en_double_pinyin.txt"),
		mapping: map[string]string{
			// 零声母
			"-a-":   "aa",
			"-e-":   "ee",
	...
	doublePinyinFlypy = schema{
		...
		desc:            "小鹤双拼",
		combinationType: "unique",
		path:            filepath.Join(RimeDir, "dicts_en/cn_en_flypy.txt"),
		mapping: map[string]string{
			// 零声母
			"-a-":   "aa",
			"-e-":   "ee",
	...
	doublePinyinMSPY = schema{
		...
		desc:            "微软双拼",
		combinationType: "unique",
		path:            filepath.Join(RimeDir, "dicts_en/cn_en_mspy.txt"),
		mapping: map[string]string{
			// 零声母
			"-a-":   "oa",
			"-e-":   "oe",
	...
	doublePinyinSogou = schema{
		...
		desc:            "搜狗双拼",
		combinationType: "unique",
		path:            filepath.Join(RimeDir, "dicts_en/cn_en_sogou.txt"),
		mapping: map[string]string{
			// 零声母
			"-a-":   "oa",
			"-e-":   "oe",
	...
	doublePinyinZiGuang = schema{
		...
		desc:            "紫光双拼",
		combinationType: "unique",
		path:            filepath.Join(RimeDir, "dicts_en/cn_en_ziguang.txt"),
		mapping: map[string]string{
			// 零声母
			"-a-":   "oa",
			"-e-":   "oe",
	...
	doublePinyinABC = schema{
		...
		desc:            "智能 ABC 双拼",
		combinationType: "unique",
		path:            filepath.Join(RimeDir, "dicts_en/cn_en_abc.txt"),
		mapping: map[string]string{
			// 零声母
			"-a-":   "oa",
			"-e-":   "oe",
...
func CnEn() {
	...
	schemas := []schema{
		{name: "cn_en", desc: "全拼", combinationType: "unique", path: filepath.Join(RimeDir, "dicts_en/cn_en.txt")},
		doublePinyin,
		doublePinyinFlypy,
		doublePinyinMSPY,
		doublePinyinSogou,
