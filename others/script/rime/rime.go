...
func init() {
	...
	HanziPath = filepath.Join(RimeDir, "dicts_cn/8105.dict.yaml")
	BasePath = filepath.Join(RimeDir, "dicts_cn/base.dict.yaml")
	ExtPath = filepath.Join(RimeDir, "dicts_cn/ext.dict.yaml")
	TencentPath = filepath.Join(RimeDir, "dicts_cn/tencent.dict.yaml")
