...
-- local truncate_comment = require("easy_en_super/filter_cand/truncate_comment")

-- local change_comment = require("easy_en_super/filter_cand/change_comment")

local get_os_name = require("easy_en_super/f_components/f_get_os_name")

local revise_comment_by_os = require("easy_en_super/filter_cand/revise_comment_by_os")
